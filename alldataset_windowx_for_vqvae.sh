...
## Stage 1
#python -u run.py \
#  --task_name vqvae --is_training 1 --root_path "$DATA_ROOT" \
...
#  --llama_name $LLAMA_NAME --learning_rate $LR --train_epochs $PRETRAIN_EPOCHS --patience $PATIENCE \
#  --num_workers 0 --loss_style $LOSS_STYLE --warmup_only $WARMUP_ONLY --kmeans_trigger_epoch $KMEANS_TRIGGER_EPOCH --build_kmeans_centers $BUILD_KMEANS_CENTERS --teacher_mode $TEACHER_MODE \
