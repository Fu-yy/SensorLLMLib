...
python -u run.py \
  ...
  --num_workers 0 --use_hard_label $use_hard_label --mask_mode $mask_mode --use_hard_label $use_hard_label --mask_mode $mask_mode --mask_rate $MASK_RATE --ts_backbone_yaml $TS_BACKBONE_YAML --vqvae_path $VQVAEPATH \
...
python -u run.py \
  ...
  --num_workers 0 --use_hard_label $use_hard_label --mask_mode $mask_mode --mask_rate $MASK_RATE --ts_backbone_yaml $TS_BACKBONE_YAML --vqvae_path $VQVAEPATH \
