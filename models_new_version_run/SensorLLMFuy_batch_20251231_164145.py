...
# ============================================================
# 2. Main Model (Route A: MAE pretrain + LLM-free classify)
# ============================================================
class Model(nn.Module):
    ...
    def __init__(self, args):
        ...
        # 4. LLM-free classification head (Stage 2)
    ...
    def forward(self, batch_x, padding_mask=None, mode: Optional[str] = None, labels=None):
        ...
        # Instance Norm (keep as-is for fair comparison)
        ...
        if mode == "classify":
            ...
            pooled = self.pool(lat)          # [B, D]  (better than mean)
            logits = self.cls_head(pooled)   # [B, num_class]
            return logits

        # ---------------------------------------------
        # Stage 1: MAE Pretraining (unchanged)
        # ---------------------------------------------
        B, L, C = x_norm.shape
