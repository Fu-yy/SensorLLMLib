...
class Model(nn.Module):
    ...
    def forward(self, x_imu, padding_mask=None, mode=None, labels=None):
        ...
        if self.stage == 1:
            ...
            loss_total = self.args.loss_recon_weight* loss_recon +self.args.loss_distill_weight* self.lambda_distill * loss_distill + self.args.loss_mse_student_weight * loss_mse_student
            # meta = {
